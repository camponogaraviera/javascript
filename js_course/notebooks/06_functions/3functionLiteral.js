/*
ES6 - Function literals (a.k.a anonymous functions)
...
Instead, it is a variable declaration. The variable `functionLiteral` is a constant that holds a reference to the function. The function, however, is not a constant, it can be called multiple times with different arguments.

For example, trying to do `functionLiteral = someOtherFunction` would result in an error.
*/
