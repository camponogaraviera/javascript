...
# Built-in Array Methods in JavaScript
    ...
    - array.indexOf(item)                         # Get the index of a specific item. O(n) time complexity. Yields -1 if the item is not found.
    - array.push(item1, item2..)                  # Push/Append new items to the end of the array in order. Returns the last item added.
    ...
    - array.splice(start, deleteCount, item1, ...)# Add or remove items from a start position onwards. The deleteCount defines the number of items to remove.
    - array.length                                # Get the length of the array.
    - array.concat()                              # Concatenate two arrays.
    - array.slice()                               # Copy a portion of the array.
    - array.reverse()                             # Reverse the array.
    - array.sort()                                # Sort the array.
    - array.map()                                 # Create a new array with the results of calling a provided function on every element in the array.
    - array.forEach()                             # Iterate over the array.
*/
