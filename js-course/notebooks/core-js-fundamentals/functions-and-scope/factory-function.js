...
function createPerson(name, age) {
  // Private variables (#private fields are only available in classes):
  ...
  return {
    ...
    // Using Object Method Shorthand to omit the function keyword:
    getAge() {
      return privateAge;
    },
  };
...
// Here, privateName and privateAge are local variables captured by closure-based encapsulation.
...
const result = someOtherFunction(); // Output: Hello from someOtherFunction!
