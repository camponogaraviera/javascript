...
function CreatePerson(name, age) {
  ...
  const privateMessage = `This is a private message from ${name}!`; // Not directly accessible from outside the constructor function.

  // Public method defined inside the constructor (not recommended for memory efficiency):
  this.sendPrivateMessage = function () {
    // This method forms a closure over privateMessage.
...
console.log(firstPerson.privateMessage); // undefined
