<!-- Badges: -->
[![Node.js](https://img.shields.io/badge/Node.js-v22.15.0-informational)](https://nodejs.org/en)
[![YARN](https://img.shields.io/badge/YARN-4.9.1-informational)](https://yarnpkg.com/)
...
This repository introduces modern JavaScript from the ground up, covering fundamentals to advanced topics.

Modern JS features: import/export (ES6), classes (ES6), async/await (ES8), rest/spread for objects (ES9), top-level await (ES13), private methods (ES13), class fields outside the constructor (ES13).
...
- [and.js](js-course/notebooks/core-js-fundamentals/control-flow/conditions/and.js)
- [or.js](js-course/notebooks/core-js-fundamentals/control-flow/conditions/or.js)
...
- [intro-and-big-O.md](js-course/notebooks/core-js-fundamentals/collections/array/intro-and-big-o.md)
...
- [intro-and-big-o.md](js-course/notebooks/core-js-fundamentals/collections/hash-table/intro-and-big-o.md)
...
- [Runtime Environment](js-course/notebooks/js-internals/runtime-env.md): Web API, JS Engine (pipeline, call stack, memory heap), Callback Queue, and Event loop.

- [Memory Management](js-course/notebooks/js-internals/memory-management.md): Garbage collection and Memory leaks.

- [WebAssembly](js-course/notebooks/js-internals/web-assembly.md)

## 8. Node.js Essentials

### 8.1 Runtime Environment

- [Node.js vs. Deno](js-course/notebooks/node-essentials/runtime-env/nodejs-vs-deno.md)

### 8.2 Core Modules

- [path.js](js-course/notebooks/node-essentials/core-modules/path.js)
- [os.js](js-course/notebooks/node-essentials/core-modules/os.js)
- [fs.js](js-course/notebooks/node-essentials/core-modules/fs.js)

### 8.3 Advanced Concurrency

- [Worker Threads](js-course/notebooks/node-essentials/advanced-concurrency/worker-threads.md)

## 9. Engine Optimization

- [hidden-classes.js](js-course/notebooks/engine-optimization/hidden-classes.js)
- [inline-caching.js](js-course/notebooks/engine-optimization/inline-caching.js)

## 10. Benchmarking For Loops vs. High-order Functions

- [benchmarking.js](js-course/notebooks/benchmarking/benchmarking.js)
...
1. It is not best practice to mix different package managers. Use either `yarn` (recommended) or `npm` to install packages during the development cycle.
