...
Modern JS features include: import/export modules (ES6), classes (ES6), async/await syntactic sugars (ES8), rest/spread operators for objects (ES9), top-level await (ES13), private methods (ES13), and class field declarations outside the constructor (ES13).
...
- [Concurrency](js-course/notebooks/advanced/node-essentials/concurrency/concurrency.md)
- [Worker Threads](js-course/notebooks/advanced/node-essentials/concurrency/worker-threads.md)

### 7.3 Engine Optimization
...
### 7.4 Benchmarking For Loops vs. High-order Functions
