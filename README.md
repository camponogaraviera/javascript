<!-- Badges: -->
[![Node.js](<https://img.shields.io/badge/Node.js_(LTS)-v22.17.0-informational>)](https://nodejs.org/en)
[![YARN](https://img.shields.io/badge/YARN-4.9.2-informational)](https://yarnpkg.com/)
...
Modern JS features include: import/export (ES6), classes (ES6), async/await (ES8), rest/spread for objects (ES9), top-level await (ES13), private methods (ES13), and class fields outside the constructor (ES13).
