...
- [constructor-function.js](js-course/notebooks/core-js-fundamentals/functions-and-scope/constructor-function.js)
  ...
  - [Intro and Big O](https://github.com/camponogaraviera/ds-and-algo/blob/main/ds_and_algo/theory/data_structures/arrays/arrays.md)
...
[3] libuv: [libuv Documentation](https://docs.libuv.org/en/v1.x/)

[4] Deno: [Deno Documentation](https://docs.deno.com/runtime/)

[5] NVM: [NVM Guide](https://www.nvmnode.com/guide/)

[6] NPM: [NPM Documentation](https://docs.npmjs.com/)

[7] Yarn: [Yarn Documentation](https://classic.yarnpkg.com/lang/en/docs/)

[8] ESLint: [ESLint Documentation](https://eslint.org/docs/latest/)

[9] Prettier: [Prettier Documentation](https://prettier.io/docs/)

[10] Jest: [Jest Documentation](https://jestjs.io/docs/getting-started)
